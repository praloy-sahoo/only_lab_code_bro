...
class MyString:
    ...
    # 1️⃣ Operator overloading for len()
    def __len__(self):
        return len(self.text)

    # 2️⃣ Length of repetitive words only
    ...
    # 3️⃣ Most frequent word using most_common()
